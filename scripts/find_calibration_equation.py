...
if __name__ == '__main__':
    ...
    a_x_final = fit_data(arr_a_x, positions)
    a_y_final = fit_data(arr_a_y, positions)
    print 'a_x = ', a_x_final
    print 'a_y = ', a_y_final


    plot_data(a_x_final[0], a_x_final[1], arr_a_x, positions, 'Position/a_x')
    plot_data(a_y_final[0], a_y_final[1], arr_a_y, positions, 'Position/a_y')

    np.savez('calibration_equation.npz', a_x=a_x_final,  a_y=a_y_final)
